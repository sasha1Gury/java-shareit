...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> updateItem(long userId, long itemId, ItemDto itemDtoWithTime) {
        return patch("/" + itemId, userId, itemDtoWithTime);
    }

    public ResponseEntity<Object> findItemByUserId(long ownerId, Integer from, Integer size) {
